...
namespace RabbitMQ.Abstraction.ProcessingWorkers
{
    public class AdvancedProcessingWorker<T> : AbstractAdvancedProcessingWorker<T> where T : class
    {
        ...
        public AdvancedProcessingWorker(IQueueConsumer consumer, Action<T> callbackAction, Action<IEnumerable<T>> batchCallbackAction = null, 
            ushort batchSize = 1, ExceptionHandlingStrategy exceptionHandlingStrategy = ExceptionHandlingStrategy.Requeue, 
        ...
        public AdvancedProcessingWorker(IQueueClient queueClient, string queueName, Action<T> callbackAction, Action<IEnumerable<T>> batchCallbackAction = null,
            ushort batchSize = 1, ExceptionHandlingStrategy exceptionHandlingStrategy = ExceptionHandlingStrategy.Requeue, 
            int invokeRetryCount = 1, int invokeRetryWaitMilliseconds = 0, 
        ...
        public static async Task<AdvancedProcessingWorker<T>> CreateAndStartAsync(IQueueConsumer consumer, 
            Action<T> callbackAction, CancellationToken cancellationToken, Action<IEnumerable<T>> batchCallbackAction = null, ushort batchSize = 1,
            ExceptionHandlingStrategy exceptionHandlingStrategy = ExceptionHandlingStrategy.Requeue,
            int invokeRetryCount = 1, int invokeRetryWaitMilliseconds = 0)
        {
            var instance = new AdvancedProcessingWorker<T>(consumer, callbackAction, batchCallbackAction, batchSize, exceptionHandlingStrategy, 
        ...
        public static async Task<AdvancedProcessingWorker<T>> CreateAndStartAsync(IQueueClient queueClient,
            string queueName, Action<T> callbackAction, CancellationToken cancellationToken, Action<IEnumerable<T>> batchCallbackAction = null, ushort batchSize = 1,
            ExceptionHandlingStrategy exceptionHandlingStrategy = ExceptionHandlingStrategy.Requeue,
            int invokeRetryCount = 1, int invokeRetryWaitMilliseconds = 0, 
            IConsumerCountManager consumerCountManager = null, IMessageRejectionHandler messageRejectionHandler = null)
        {
            var instance = new AdvancedProcessingWorker<T>(queueClient, queueName, callbackAction, batchCallbackAction, batchSize,
