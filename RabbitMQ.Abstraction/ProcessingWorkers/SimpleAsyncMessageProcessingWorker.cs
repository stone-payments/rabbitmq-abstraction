...
namespace RabbitMQ.Abstraction.ProcessingWorkers
{
    public class SimpleAsyncMessageProcessingWorker<T> : AbstractSimpleMessageProcessingWorker<T> where T : class
    {
        ...
        public static async Task<SimpleAsyncMessageProcessingWorker<T>> CreateAndStartAsync(IQueueConsumer consumer, 
        ...
        public static async Task<SimpleAsyncMessageProcessingWorker<T>> CreateAndStartAsync(IQueueClient queueClient, 
        ...
        public override async Task OnMessageAsync(T message, IMessageFeedbackSender feedbackSender, CancellationToken cancellationToken)
        {
            try
            {
