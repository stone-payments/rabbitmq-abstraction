...
namespace RabbitMQ.Abstraction.ProcessingWorkers
{
    public class SimpleMessageProcessingWorker<T> : AbstractSimpleMessageProcessingWorker<T> where T : class
    {
        ...
        public static async Task<SimpleMessageProcessingWorker<T>> CreateAndStartAsync(IQueueConsumer consumer, 
        ...
        public static async Task<SimpleMessageProcessingWorker<T>> CreateAndStartAsync(IQueueClient queueClient, 
